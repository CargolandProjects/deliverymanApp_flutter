...
import 'package:stackfood_multivendor_driver/feature/referral/screens/referral_screen.dart';
import 'package:stackfood_multivendor_driver/feature/referral/bindings/referral_binding.dart';
...
class RouteHelper {
  ...
  static String getReferralRoute() => '/referrals';
  ...
  static List<GetPage> routes = [
    ...
    // Referral Screen Added
    GetPage(
      name: getReferralRoute(),
      page: () => const ReferralScreen(),
      binding: ReferralBinding(), // <-- injects Controller/Service/Repository
    ),
  ];
}
