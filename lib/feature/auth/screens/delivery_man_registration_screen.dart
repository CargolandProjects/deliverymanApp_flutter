...
class _DeliveryManRegistrationScreenState
  ...
  final FocusNode _referralCodeNode = FocusNode();
                              ...
                              Visibility(
                                ...
                                child: Column(children: [
                                  ...
                                  CustomTextFieldWidget(
                                    ...
                                    hintText: 'enter_referral_code_optional'.tr,
                                      ...
                                      Row(children: [
                                        Expanded(
                                          ...
                                          child: CustomDropdown<int>(
                                            ...
                                            items: dmTypeList,
                                            child:
                                                Text('select_delivery_type'.tr),
                                          ),
                                        )),
                                        const SizedBox(
                                            width: Dimensions.paddingSizeSmall),
                                        Expanded(
                                            child: addressController.zoneList !=
                                                    null
                                                ? Container(
                                                    decoration: BoxDecoration(
  ...
  void _addDeliveryMan(AuthController authController,
    ...
    String referralCode =
        _referralCodeController.text.trim(); // ✅ referral code
    ...
    if (authController.dmStatus == 0.4) {
      ...
      if (authController.dmTypeIndex == -1) {
        ...
        if (referralCode.isNotEmpty) {
          data.addAll({'referral_code': referralCode});
        }
